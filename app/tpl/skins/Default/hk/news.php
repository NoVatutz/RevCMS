...
if(mysql_result(mysql_query("SELECT role FROM users WHERE id = '" . $_SESSION['user_id'] . "'"), 0) >= 7)
{
	if(isset($_GET["done"]))
	{
	...
	{
		if($_POST["title"] == NULL || $_POST["shortstory"] == NULL || $_POST["mainstory"] == NULL)
		{
		...
		else
		{
			...
			$_SESSION["mainstory"] = filter($_POST["mainstory"]);
	...
	Main story <br />
	<textarea id="content1" name="mainstory" class="mceEditor" cols="85" rows="10"></textarea>
