...
if(isset($_POST["proceed"]))
{
	...
	mysql_query("INSERT INTO cms_news (title,shortstory,longstory,published,image,author) VALUES ('" . $_SESSION["title"] . "', '" . $_SESSION["shortstory"] . "', '" . $_SESSION["longstory"] . "', '" . date("m.d.y") . "', '" . $_POST["topstory"] . "', '" . $author . "')") or die(mysql_error());
