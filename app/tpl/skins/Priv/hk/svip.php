 <div id="main">
	...
	if(isset($_POST['give']))
	{	
		if(mysql_num_rows(mysql_query("SELECT * FROM users WHERE username = '" . filter($_POST['username']) . "'")) < 1){ echo "User does not exist."; }
		else {
		mysql_query("UPDATE users SET rank = 3, credits = credits + '2000000', activity_points = activity_points + '2000000' WHERE username = '" . filter($_POST['username']) . "'"); echo "<b>Success!</b>"; }
	}
